    ...
    E: Entity<K>,
{
    ...
    pub fn copy(entity_ref: EntityRef<K, E>) -> Self {
        Self {
            entity: entity_ref.entity.clone(),
            phantom_data: PhantomData,
        }
    }
    pub fn entity(self: &Self) -> &Arc<E> {
        &self.entity
    }
...
impl<K, E> Clone for EntityRef<K, E>
where
    K: Eq + Hash + Clone,
    E: Entity<K>,
{
...
impl<K, E> std::ops::Deref for EntityRef<K, E>
where
    K: Eq + Hash + Clone,
    E: Entity<K>,
{
    ...
    E: Entity<K>,
{
    ...
    pub fn from_iter_ref(entities: impl Iterator<Item = EntityRef<K, E>>) -> Self {
        let entities = entities
            .map(|entity_ref| (entity_ref.key(), entity_ref.clone()))
            .collect();
        Self {
    ...
    pub fn from_iter(entities: impl Iterator<Item = E>) -> Self {
        let entities = entities
            .map(|entity| (entity.key(), EntityRef::new(entity)))
            .collect();
        Self {
            entities: RwLock::new(entities),
        }
    ...
    pub fn find(
        self: &Self,
        predicate: impl Fn(&EntityRef<K, E>) -> bool,
    ) -> Option<EntityRef<K, E>> {
        match self
            .entities
            .read()
            .unwrap()
            .iter()
            .find(|&item| predicate(item.1))
        {
    ...
    pub fn values(self: &Self) -> Vec<EntityRef<K, E>> {
        self.entities
            ...
            .unwrap()
            .values()
            .map(|entity_ref| entity_ref.clone())
            .collect()
    }
}
...
mod tests {
    ...
    impl TestEntity {
        pub fn new(id: usize, name: String) -> Self {
            Self {
                id,
                state: RwLock::new(TestEntityState { name }),
            }
        }
    ...
    impl TestEntityList {
        pub fn new(id: usize) -> Self {
            Self {
                id,
                test_entities: EntityList::new(),
            }
        }

        pub fn test_entities(self: &Self) -> &EntityList<usize, TestEntity> {
            &self.test_entities
        }
    }
    ...
    pub fn entities_containing_lists() {
        ...
        entity
            .test_entities()
            .insert(TestEntity::new(1, String::from("Test 1")));
        entity
            .test_entities()
            .insert(TestEntity::new(2, String::from("Test 2")));
        entity
            .test_entities()
            .insert(TestEntity::new(3, String::from("Test 3")));
